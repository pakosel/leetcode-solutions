...
We stack glasses in a pyramid, where the **first** row has `1` glass, the **second** row has `2` glasses, and so on until the <code>100<sup>th</sup></code> row.  Each glass holds one cup of champagne.
