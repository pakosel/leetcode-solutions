...
namespace InsertDeleteGetRandomWithDuplicates
{
    ...
    public class SolutionTest
    {
        ...
        {
            new object[] {new string[] {"insert","insert","insert","getRandom","remove","getRandom"}, new int?[] {1,1,2,null,1,null}, new object[] {true,false,true,1,true,1}},
            ...
            new object[] {new string[] {"insert","insert","getRandom","getRandom","insert","remove","getRandom","getRandom","insert","remove"}, new int?[] {3,3,null,null,1,3,null,null,0,0}, new object[] {true,false,3,3,true,true,3,3,true,true}},
        ...
        {
            var coll = new RandomizedCollection();
            var ret = true;
            var retI = 0;
